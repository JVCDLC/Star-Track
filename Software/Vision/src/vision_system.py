...
if __name__ == "__main__":
    ...
    VIDEO_SOURCE = "C:\\Users\\franc\\OneDrive\\Université\\S4\\Projet\\Code\\Star-Track\\Software\\Movement\\phone_communication\\simulation.mp4" if SIMULATE_VIDEO else "ipc:///tmp/video_feed"
    # ---------------------------------------------------------
